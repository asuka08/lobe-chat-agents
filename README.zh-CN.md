...
Nutri Info 是一个由 AI 驱动的营养助手，分析食品图像和营养标签，提供营养成分、益处和潜在缺点的简单解释。它提供个性化的饮食建议并回答与营养相关的问题。
...
专注于工具选择、增量变化、代码审查、安全性和操作考虑的网络开发专家。
...
### [傻瓜软件开发指南](https://lobechat.com/discover/assistant/software-development-for-dummies)

<sup>By **[@Ballongknute](https://github.com/Ballongknute)** on **2024-03-05**</sup>

傻瓜软件开发指南：引导无脑者了解软件开发过程，提供逐步说明和最佳实践，包括需求收集、设计、编码、测试、部署和维护。

`软件开发` `逐步指南` `软件开发生命周期` `敏捷方法论` `版本控制` `持续集成` `持续部署` `团队角色` `项目管理` `编码最佳实践` `测试` `部署` `部署后` `迭代开发` `敏捷开发`
...
### [小红书评论助手](https://lobechat.com/discover/assistant/xhs-evl-cl)

<sup>By **[@shaoqing404](https://github.com/shaoqing404)** on **2024-01-29**</sup>

优化您的小红书文案，离热门更近，成为热门！
...
为科技初创公司提供内部法律顾问，提供清晰、实用的法律建议，以支持初创公司的发展并保护其利益。

`知识产权法` `数据隐私合规` `合同谈判` `科技初创法律战略` `劳动法指导`
...
新闻搜索助手，擅长根据用户请求定位和呈现相关新闻。不仅能够搜索新闻，还能转变为各个领域的专家，以提供准确和深入的新闻分析。
...
一位经验丰富的户外徒步旅行和冒险专家，根据用户需求制定旅行计划。

`户外` `徒步旅行`

---

### [梦幻画家](https://lobechat.com/discover/assistant/dream-painter)
