...
### [合同管理专家](https://lobechat.com/discover/assistant/contract-management-specialist)
...
### [行业分析专家](https://lobechat.com/discover/assistant/industry-analyst)
...
### [发票管理专家](https://lobechat.com/discover/assistant/invoice-management-specialist)
...
### [企业全景分析师](https://lobechat.com/discover/assistant/corporate-panorama-analyst)

<sup>By **[@wjw](https://github.com/GodweiLL)** on **2025-03-04**</sup>

资深企业分析师，专注全景分析与竞争情报研究

`企业诊断` `风险管理`

---

### [智能招聘评估专家](https://lobechat.com/discover/assistant/intelligent-recruitment-management)
...
### [员工档案管理系统](https://lobechat.com/discover/assistant/employee-file-management-system)
...
Specializes in designing poetry cards to enhance artistic sense and appeal

`poetry card design` `card` `creativity` `artistic expression`

---

### [Python Master](https://lobechat.com/discover/assistant/yunchat)

<sup>By **[@yuyun2000](https://github.com/yuyun2000)** on **2024-11-30**</sup>

Proficient in Python development and deep learning, skilled in tool selection and code optimization
...
A psychology expert for analyzing the underlying psychological motives behind people's behavior in the workplace, possible psychological motive analysis
...
A professional meeting report assistant that extracts key points from meetings into reporting sentences
...
The strongest AI rewriting prompt ever! Complete violent rewriting in one minute, imitate public account articles, create a headline article production line, generate Bilibili video scripts, write Xiaohongshu copy, optimize online writing, polish reports, theses, translated texts, and generate SEO articles in bulk...
...
Specializing in bilingual education, analyzing the meanings of English words, example sentences, roots and affixes, historical background, and memory techniques
...
Professional career development planning and entrepreneurship consulting, providing practical suggestions through an in-depth understanding of user situations.
...
### [New Interpretation of Chinese](https://lobechat.com/discover/assistant/hanyuxinjie)

<sup>By **[@李继刚](https://m.okjike.com/users/752D3103-1107-43A0-BA49-20EC29D09E36)** on **2024-09-19**</sup>

Specializing in explaining Chinese vocabulary from a new perspective / So, what word are they using to deceive you this time?
...
A project naming master who can help you come up with a name that aligns with your project's expectations.
...
The RO-SCIRAW framework is a prompt methodology pioneered by Kirk Lin, providing a new paradigm for constructing highly precise and efficient prompts. Please enter the information for the avatar you want to create.

`Prompt Framework`

---

### [MBTI Type Tester](https://lobechat.com/discover/assistant/mbti-1)

<sup>By **[@ffha](https://github.com/ffha)** on **2024-07-15**</sup>

Specializes in MBTI type testing and portrait generation.

`mbti test` `questionnaire design` `psychology expert` `painting` `personality portrait`

---

### [MySQL Good Teacher](https://lobechat.com/discover/assistant/mysql-haoteacher)

<sup>By **[@yayoinoyume](https://github.com/yayoinoyume)** on **2024-06-09**</sup>

MySQL Good Teacher is a great teacher that helps everyone learn MySQL.
...
Skilled in NGS data processing and visualization

`Bioinformatics` `NGS Data Processing` `Data Visualization`

---

### [Daoist Master](https://lobechat.com/discover/assistant/taoists)

<sup>By **[@epochaudio](https://github.com/epochaudio)** on **2024-05-22**</sup>

Expert in Daoist philosophy, answering doubts, advocating for inner peace
...
An experienced learning planner who creates detailed and easily achievable study plans, searches for relevant information, and adjusts plans.

`Learning plan formulation` `User communication` `Search for relevant information` `Adjust study plans` `Tutorial links`

---

### [Master of Destiny](https://lobechat.com/discover/assistant/fortune-teller)

<sup>By **[@kamilkenrich](https://github.com/kamilkenrich)** on **2024-04-13**</sup>

Specializes in destiny studies, divination, astrology, and blood type analysis
...
Interpreting the 'subtext' behind what girls say, with sharp and strong replies! 🔥

`girlfriend` `girl` `subtext` `fierce` `strong` `interpretation`

---

### [Medication Guide Expert](https://lobechat.com/discover/assistant/medication-guide)

<sup>By **[@ccsen](https://github.com/ccsen)** on **2024-03-17**</sup>

Specializes in interpreting and comparing drug information
...
Skilled in using Markdown syntax for text structuring and highlighting key points
...
Skilled at using `shields.io` to generate beautiful badges

`Badge Generator` `Beautification` `UI Design` `Markdown` `Tech Stack` `shields-io`

---

### [Text Summary Assistant](https://lobechat.com/discover/assistant/summary-assistant)

<sup>By **[@muxinxy](https://github.com/muxinxy)** on **2024-01-25**</sup>

Skilled at accurately extracting key information and providing concise summaries

`Text Summary` `Information Extraction` `Concise` `Accuracy`
...
Specializes in designing unique and charming figures based on user requirements.
...
`Emoji Generation` `emoji` `creativity`
...
### [Performance Evaluation Superstar](https://lobechat.com/discover/assistant/kpi-hero)

<sup>By **[@canisminor1990](https://github.com/canisminor1990)** on **2024-01-05**</sup>

Skilled in writing performance evaluation reports and year-end summaries
...
SVG flowchart explanation, input SVG source code, explain the flowchart

`flowchart explanation` `technical documentation` `business knowledge`
...
Aimed at helping users write engaging and trendy short video scripts
...
`Creativity` `Brainstorming` `Design` `Brand` `Methods`
...
Naming expert, helping you obtain unique and meaningful names.
...
Accurately describe the usage of the API, providing example code, notes, and return value type definitions.
...
If you need to expand a title into a description, this assistant can help you write content
